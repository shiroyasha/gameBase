...
(function() {
  define(function(require, exports, module) {
    var AsteroidHandler, MASS, MAX_DISTANCE, MAX_ROTATION, MIN_DISTANCE, NUM_OF_ASTEROIDS, RADIUS, RADIUS_VARIATION, SPEED, SPEED_VARIATION, createNewAsteroid, magnitude;
    ...
    AsteroidHandler.updateAsteroids = function(model) {
      var aster, centerX, centerY, i, _i, _j, _len, _ref, _ref1, _results;
      centerX = model.me.position.x;
      centerY = model.me.position.y;
      _ref = model.asteroids;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        aster = _ref[_i];
        if ((aster != null) && magnitude(aster.position.x - centerX, aster.position.y - centerY) > MAX_DISTANCE) {
